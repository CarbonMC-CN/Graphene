...
//村民
    ...
    //物品缝合
    public static final ForgeConfigSpec.EnumValue<ItemVFX> ITEM_STITCHING_METHOD;
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.push("Math");
        RandomOptimizeENABLED = BUILDER
                .comment("Random性能优化")
                .define("OptiRandom", true);
        Absoptimize = BUILDER
                .comment("Abs性能优化")
                .define("OptiAbs", true);
        BUILDER.pop();
    ...
    public static boolean isVanilla()  { return ITEM_STITCHING_METHOD.get() == ItemVFX.VANILLA; }
    public static boolean isUnlerp()   { return ITEM_STITCHING_METHOD.get() == ItemVFX.UNLERP; }
    public static boolean isOutline()  { return ITEM_STITCHING_METHOD.get() == ItemVFX.OUTLINE; }
    public static boolean isPixel()    { return ITEM_STITCHING_METHOD.get() == ItemVFX.PIXEL; }
    public static boolean isFull_QUAD()    { return ITEM_STITCHING_METHOD.get() == ItemVFX.FULL_QUAD; }
    ...
    public enum ItemVFX {
        VANILLA, UNLERP, OUTLINE, PIXEL, FULL_QUAD;

        private static ItemVFX[] vals = values();
        public ItemVFX next() {
